...
This mod is for **Minecraft 1.21.11**.
...
<img width="426" height="240" alt="DelayPackets" src="https://github.com/user-attachments/assets/532d594e-365b-4d7f-bba0-b5220a92f104" />
...
Your settings should match the screenshot below.

<img width="437" height="261" alt="fabricinstallersetupimage" src="https://github.com/user-attachments/assets/aeebd221-532f-47ad-9db4-12fdb52e7323" />

Click Install. Once the installation is complete, you'll need to install [Fabric API](https://modrinth.com/mod/fabric-api/version/0.141.5+1.21.11), return to the Fabric website and click Download Fabric API. Download the version of Fabric API that matches Minecraft 1.21.11.
...
<img width="778" height="220" alt="wrongloaderverfabric" src="https://github.com/user-attachments/assets/31d5a546-267d-498c-aa91-463fbf32e517" />

### Incorrect Minecraft Version

This error means you are **not** running the correct version of Minecraft. This mod requires **Minecraft 1.21.11**.

<img width="776" height="243" alt="incorrectmcvererror" src="https://github.com/user-attachments/assets/765bc881-b540-4004-8bda-d5b1243d7a16" />
